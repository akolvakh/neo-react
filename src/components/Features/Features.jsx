            ...
            <div className={styles.rvCard__features}>
                ...
                {camper?.transmission && (
                        <span className={styles.rvCard__badge}>
                            <SvgIcon path="transmission" size={16} /> {camper.transmission.charAt(0).toUpperCase() + camper.transmission.slice(1)}
                        </span>
                    )}
                    {camper?.form && (
                        <span className={styles.rvCard__badge}>
                    ...
                    {camper?.engine && (
                        <span className={styles.rvCard__badge}>
                            <SvgIcon path="engine" size={16} /> {camper.engine.charAt(0).toUpperCase() + camper.engine.slice(1)}
                        </span>
                    )}
                    {camper?.AC && (
                        <span className={styles.rvCard__badge}>
