        ...
        <div className={styles.rvCard}>
            ...
            <div className={styles.rvCard__details}>
                ...
                <div className={styles.rvCard__features}>
                    {rv.transmission && <span className={styles.rvCard__badge}>{rv.transmission}</span>}
                    {rv.form && <span className={styles.rvCard__badge}>{rv.form}</span>}
                    {rv.engine && <span className={styles.rvCard__badge}>{rv.engine}</span>}
                    ...
                    {rv.radio && <span className={styles.rvCard__badge}>Radio</span>}
                    {rv.refrigerator && <span className={styles.rvCard__badge}>Refrigerator</span>}
                    {rv.microwave && <span className={styles.rvCard__badge}>Microwave</span>}
                    {rv.gas && <span className={styles.rvCard__badge}>Gas</span>}
                    {rv.water && <span className={styles.rvCard__badge}>Water</span>}
                </div>
                <div>
                    <h3>{rv.name}</h3>
